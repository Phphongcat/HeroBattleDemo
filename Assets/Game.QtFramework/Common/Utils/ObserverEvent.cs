...
/// </summary>
public sealed class ObserverEvent
{
    ...
    public static void EmitEvent(string eventName, object sender)
    {
        ...
        if (ObserverEvent.sender.ContainsKey(eventName)) ObserverEvent.sender[eventName] = sender;
        else ObserverEvent.sender.Add(eventName, sender);
